"""
Django settings for drf_oauth2_demo project.
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'corsheaders',
    'apis.authorization.apps.AuthorizationConfig',
    'apis.resoure.apps.ResoureConfig',
]
...
ROOT_URLCONF = 'drf_oauth2_demo.urls'
...
WSGI_APPLICATION = 'drf_oauth2_demo.wsgi.application'
